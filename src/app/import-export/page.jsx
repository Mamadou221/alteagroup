          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold mb-6 text-neutral-900 dark:text-white">
                {t("servicePages.importExport.title")}
              </h1>
              ...
              <ul className="list-none space-y-3 mb-8">
                {(t("servicePages.importExport.highlights") || []).map((h, i) => (
                  <motion.li
                    key={i}
            ...
            >
              <div className="relative rounded-xl overflow-hidden shadow-strong">
                <Image
                  src="https://uprodemy.com/wp-content/uploads/2022/10/Comparison-of-export-and-import.webp"
                  alt={t("alt.importExport")}
                  width={600}
                  height={400}
