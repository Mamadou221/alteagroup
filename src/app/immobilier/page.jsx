          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold mb-6 text-neutral-900 dark:text-white">
                {t("servicePages.realEstate.title")}
              </h1>
              ...
              <ul className="list-none space-y-3 mb-8">
                {(t("servicePages.realEstate.highlights") || []).map((h, i) => (
                  <motion.li
                    key={i}
            ...
            >
              <div className="relative rounded-xl overflow-hidden shadow-strong">
                <Image
                  src="https://keurcity.com/wp-content/uploads/2021/01/Estimer-_valeur-bien-immobilier-Senegal.jpg"
                  alt={t("alt.realEstate")}
                  width={600}
                  height={400}
